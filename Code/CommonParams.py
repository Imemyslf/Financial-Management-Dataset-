...
reliance = pd.read_excel("../data/Reliance/QuarterlyExcel/1_Sep13_Sep14.xlsx")
# larsen_Toubro = pd.read_excel("./data/LarsenToubro/Excel/larsenToubro_yearly.xlsx")
# reliance = pd.read_excel("./data/Reliance/Excel/reliance_yearly.xlsx")
...
# common_parameters = adani_Ports.index.intersection(larsen_Toubro.index).intersection(reliance.index)i
