...
# df["rolling_mean"] = df["y"].rolling(window=4, min_periods=1).mean()  # Ensure at least 1 value
...
# # Forecast revenue and expenditure with more robust method
...
# plt.fill_between(future["ds"], prophet_future_pred["yhat_lower"], prophet_future_pred["yhat_upper"], color="green", alpha=0.2, label="Forecast 80% CI")
# plt.axvline(x=df["ds"].iloc[-1], color="black", linestyle="--", label="Forecast Start")
# plt.title("Hybrid Prophet + XGBoost Net Profit Forecast for 3i Infotech")
# plt.xlabel("Date")
...
# # Print forecast
# print("Forecast for next 8 quarters:")
# print(future[["ds", "yhat"]].round(2))
